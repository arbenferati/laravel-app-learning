<x-app-layout>
    <x-slot name="slot">
        ...
        <a href="{{ url('/app' . '/' . $application->title) }}" class="flex flex-col items-center h-64 w-64 m-6 shadow-xl bg-indigo-50 rounded-full p-10 hover:bg-indigo-200 transition duration-500 ease-in-out">
