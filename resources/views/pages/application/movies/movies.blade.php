    ...
    <x-slot name="slot">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-8 p-8 items-start">
            ...
            <div class="mt-4 rounded-t-xl overflow-hidden shadow">
                ...
                <div class="p-4">
                    <p class="text-2xl font-semibold truncate"><a href="{{ url('/app/movies' . '/' . $movie['id']) }}">{{ $movie['title'] }}</a></p>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-8 p-8 items-start mt-6">
